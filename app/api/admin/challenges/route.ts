...
export async function POST(request:Request) {
  ...
  try {
    ...
    if(generated.source === "fallback") console.warn("ai_challenge_fallback",{
      request_id:input.request_id,reason:generated.diagnostic,status:generated.provider_status,code:generated.provider_code,validation:generated.validation_detail,
    });
    ...
    return Response.json({...batch,diagnostic:generated.diagnostic,provider_status:generated.provider_status,provider_code:generated.provider_code,validation_detail:generated.validation_detail,adjusted_fields:generated.adjusted_fields},{headers});
