...
const chapters = [
  ...
  },
  {
    ...
    paragraphs: [
      "Ouvre Messages dans le menu du bas, puis choisis une personne de ton cercle. Seuls les amis ayant accepté ton invitation peuvent échanger. Écris ton texte et appuie sur Envoyer ; attends sa confirmation. La conversation s’actualise toutes les dix secondes lorsque le jeu est visible.",
