...
const chapters = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Ouvre Profil → Personnaliser mon avatar : la Boutique propose de nouveaux accessoires, titres et décors à acheter avec des Éclats. Chaque tranche de 50 XP rapporte 25 Éclats, y compris tes XP déjà acquis, une seule fois. Tes XP et ton niveau ne diminuent jamais lors d’un achat. Essaie une pièce, confirme son prix puis équipe-la depuis Ma collection. Les achats sont définitifs ; les Éclats sont gratuits, personnels et sans valeur monétaire. Les anciens objets se débloquent toujours par la progression. Les conditions affichées indiquent les XP ou badges nécessaires. Les effets animés apparaissent sur le grand avatar ; les petites vignettes restent statiques. Le mode calme et la réduction des animations du téléphone arrêtent les mouvements. Tes éléments équipés et tes badges peuvent apparaître auprès de tes amis et dans les classements.",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      "Ouvre Messages dans le menu du bas, puis choisis une personne de ton cercle. Seuls les amis ayant accepté ton invitation peuvent échanger. Écris ton texte et appuie sur Envoyer ; attends sa confirmation. La conversation s’actualise toutes les dix secondes lorsque le jeu est visible. La liste affiche un aperçu du dernier message et sa date, avec les conversations récentes en premier. Toucher une notification de message ouvre directement la conversation, si vous êtes toujours amis.",
      "Les messages sont limités à 2 000 caractères, 20 envois par minute et 200 par jour (heure de Paris). Ils ne rapportent ni minutes ni XP. Tu peux aussi ouvrir Emojis composés, choisir un sticker publié par l’administration puis appuyer sur Envoyer. Les stickers partagent les limites des messages et restent lisibles après leur retrait du catalogue. Les fichiers joints ne sont pas pris en charge. Sous un message, choisis 👏, 💪, 😂 ou ❤️ : une réaction par personne, remplaçable ; reclique pour la retirer. Les compteurs sont visibles aux deux amis. Les réactions ne déclenchent pas de notification supplémentaire. Les messages envoyés ne sont pas directement modifiables ou supprimables.",
      "Le nombre de non-lus apparaît sur l’onglet Messages et auprès de chaque ami dans la messagerie. Les anciens échanges se consultent avec Voir les messages précédents. Les messages récupérés dans une conversation active sont marqués comme lus ; ouvrir seulement la liste des conversations ne les marque pas comme lus.",
      ...
      "Un blocage, une suspension ou la fin de l’amitié coupe l’accès à la conversation dans le jeu. Les échanges restent conservés dans les données du compte et leur export, jusqu’à une éventuelle suppression définitive du compte par l’administration. La messagerie ne propose pas de chiffrement de bout en bout : évite d’y envoyer des mots de passe ou des informations sensibles.",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Chaque déclaration partagée et chaque premier encouragement sur une déclaration déclenchent une alerte, sans regroupement horaire. Modifier ou retirer puis remettre la même réaction ne multiplie pas les alertes. Active aussi « Activité de mes amis » pour les encouragements. Les notifications du téléphone sont envoyées dès leur création, selon tes autorisations et tes heures silencieuses ; leur affichage dépend du téléphone et du réseau.",
