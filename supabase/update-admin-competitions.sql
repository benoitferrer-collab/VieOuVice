-- Mise à jour viegame : après migrations 001, 002 et 003 uniquement.
-- Exécuter UNE FOIS dans Supabase SQL Editor. Ne pas rejouer install.sql.
-- Inclut les compétitions, les historiques partagés et l’activation admin de bfe@nomios.fr.
-- Email, UUID et profil doivent correspondre ; toute erreur annule l’ensemble.
begin;
