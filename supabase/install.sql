-- INSTALLATION COMPLÈTE : à exécuter une seule fois dans SQL Editor.
-- Tables + RPC + RLS + catalogue + publication Realtime.
-- Projet vierge uniquement. Aucun utilisateur ni aucune donnée existante ne sont supprimés.
-- Transaction unique : toute erreur annule cette installation.
begin;
...
commit;
-- Puis activer Cron dans Supabase et exécuter supabase/jobs.sql.
